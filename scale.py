...
# For demonstration, simulating dataset loading
# total_images = 100  # Simulate 100 images
# height, width = 64, 64  # Example dimensions
# all_images_array = np.random.randint(0, 255, (total_images, height, width), dtype=np.uint8)

image_id = 1  # For display purposes
...
tolerance = 5  # Define tolerance range
...
subsample_factor = 10  # Adjust this factor as needed
